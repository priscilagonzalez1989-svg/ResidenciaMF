...
// ── DOCENTES (magic link sin cuenta fija) ────────────────────────────────────
const EMAILS_DOCENTES = [
  "priscilagonzalez@gmail.com", // reemplazar con emails reales del equipo
];

const esDocente = (email) => {
  // Si no es ninguna de las residentes conocidas → es docente
  const EMAILS_RESIDENTES = [
    "magdalenafn96@gmail.com",
    "mariacatalinaalricscavarda@gmail.com",
    "violetacargnelutti@gmail.com",
  ];
  return !EMAILS_RESIDENTES.includes(email?.toLowerCase());
};
